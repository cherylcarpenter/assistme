---
summary: "Use NVIDIA's OpenAI-compatible API in AssistMe"
read_when:
  - You want to use NVIDIA models in AssistMe
...
assistme onboard --auth-choice skip
assistme models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
