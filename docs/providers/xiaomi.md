---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with AssistMe"
read_when:
  - You want Xiaomi MiMo models in AssistMe
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). AssistMe uses
