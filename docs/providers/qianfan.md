---
summary: "Use Qianfan's unified API to access many models in AssistMe"
read_when:
...
3. AssistMe installed on your system
...
4. Copy the API key for use with AssistMe

## CLI setup

```bash
assistme onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [AssistMe Configuration](/gateway/configuration)
