...
You can point AssistMe at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or AssistMe
...
- [Anthropic provider](/providers/anthropic) - Native AssistMe integration with Claude setup-token or API keys
