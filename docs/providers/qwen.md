---
summary: "Use Qwen OAuth (free tier) in AssistMe"
read_when:
  - You want to use Qwen with AssistMe
...
If you already logged in with the Qwen Code CLI, AssistMe will sync credentials
