---
summary: "Use Synthetic's Anthropic-compatible API in AssistMe"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. AssistMe registers it as the
...
Note: AssistMe's Anthropic client appends `/v1` to the base URL, so use
