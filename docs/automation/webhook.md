...
read_when:
  ...
  - Wiring external systems into AssistMe
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your AssistMe config directory (typically `~/.assistme/hooks/transforms`).
...
- `assistme webhooks gmail setup` writes `hooks.gmail` config for `assistme webhooks gmail run`.
