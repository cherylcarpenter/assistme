...
AssistMe treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.assistme/settings/voicewake.json`

Shape:

```json
{ "triggers": ["assistme", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
