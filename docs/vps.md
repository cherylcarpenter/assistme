---
summary: "VPS hosting hub for AssistMe (Oracle/Fly/Hetzner/GCP/exe.dev)"
read_when:
...
- `ASSISTME_NO_RESPAWN=1` avoids extra startup overhead from a self-respawn path.
...
- Add service env for stable startup path:
  - `ASSISTME_NO_RESPAWN=1`
  - `NODE_COMPILE_CACHE=/var/tmp/assistme-compile-cache`
