...
AssistMe ships three update channels:
...
When you **explicitly** switch channels with `--channel`, AssistMe also aligns
the install method:
...
When you switch channels with `assistme update`, AssistMe also syncs plugin sources:
