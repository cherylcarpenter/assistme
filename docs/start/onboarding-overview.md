---
summary: "Overview of AssistMe onboarding options and flows"
read_when:
...
AssistMe supports multiple onboarding paths depending on where the Gateway runs
...
- [`assistme onboard` command](/cli/onboard)

## macOS app onboarding

Use the AssistMe app when you want a fully guided setup on macOS. Docs:
