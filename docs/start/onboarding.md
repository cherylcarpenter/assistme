---
summary: "First-run onboarding flow for AssistMe (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give AssistMe">
...
<Step title="CLI">
  ...
  The app can install the global `assistme` CLI via npm/pnpm so terminal
