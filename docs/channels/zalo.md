...
- Install via CLI: `assistme plugins install @assistme/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `assistme plugins install ./extensions/zalo`
   - From npm (if published): `assistme plugins install @assistme/zalo`
...
- Approve via:
  - `assistme pairing list zalo`
  - `assistme pairing approve zalo <CODE>`
...
- Example: `assistme message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `assistme channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `assistme logs --follow`
