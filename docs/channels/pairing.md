...
read_when:
  ...
  - Reviewing AssistMe security posture
title: "Pairing"
---

# Pairing

“Pairing” is AssistMe’s explicit **owner approval** step.
...
Stored under `~/.assistme/credentials/`:
...
3. On your phone, open the AssistMe iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `assistme nodes pending/approve`) is a
