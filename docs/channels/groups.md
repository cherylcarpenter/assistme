...
AssistMe treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

AssistMe “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, AssistMe can see that group and respond there.
...
Translation: allowlisted senders can trigger AssistMe by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@assistme", "assistme", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
