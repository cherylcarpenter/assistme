...
本指南总结了在 AssistMe 中开发 Pi 集成的合理工作流程。
...
状态存储在 AssistMe 状态目录下。默认为 `~/.assistme`。如果设置了 `ASSISTME_STATE_DIR`，则使用该目录。
...
- https://docs.assistme.ai/testing
- https://docs.assistme.ai/start/getting-started
