...
export default defineConfig({
  resolve: {
    // Keep this ordered: the base `assistme/plugin-sdk` alias is a prefix match.
    alias: [
      {
        find: "assistme/plugin-sdk/account-id",
        replacement: path.join(repoRoot, "src", "plugin-sdk", "account-id.ts"),
      },
      {
        find: "assistme/plugin-sdk/keyed-async-queue",
        replacement: path.join(repoRoot, "src", "plugin-sdk", "keyed-async-queue.ts"),
      },
      {
        find: "assistme/plugin-sdk",
