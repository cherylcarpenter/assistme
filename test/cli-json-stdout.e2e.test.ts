    ...
    await withTempHome(
      async (tempHome) => {
        ...
        const env = {
          ...
          ASSISTME_TEST_FAST: "1",
        };
        delete env.ASSISTME_HOME;
        delete env.ASSISTME_STATE_DIR;
        delete env.ASSISTME_CONFIG_PATH;
        delete env.VITEST;

        const entry = path.resolve(process.cwd(), "assistme.mjs");
