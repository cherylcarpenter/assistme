...
- Keep product names in English: AssistMe, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the AssistMe Gateway, use “Gateway 网关”.
