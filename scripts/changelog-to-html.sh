...
if [[ -z "$version_content" ]]; then
  echo "<h2>AssistMe $VERSION</h2>"
  echo "<p>Latest AssistMe update.</p>"
  echo "<p><a href=\"https://github.com/assistme/assistme/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
