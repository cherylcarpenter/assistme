...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "assistme", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for AssistMe. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("AssistMe Issue Label Audit");
