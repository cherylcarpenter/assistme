...
show_usage() {
    cat << EOF
clawlog - AssistMe Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View AssistMe logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    AssistMe logs flow through the macOS unified log (subsystem: ai.assistme).
