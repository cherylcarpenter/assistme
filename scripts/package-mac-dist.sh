...
# Output:
# - dist/AssistMe.app
# - dist/AssistMe-<version>.zip
# - dist/AssistMe-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.assistme.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/AssistMe.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/AssistMe-$VERSION.zip"
DMG="$ROOT_DIR/dist/AssistMe-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/AssistMe-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/AssistMe-$VERSION.dSYM.zip"
