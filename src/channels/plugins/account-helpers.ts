...
export function createAccountListHelpers(channelKey: string) {
  function resolveConfiguredDefaultAccountId(cfg: AssistMeConfig): string | undefined {
  ...
  function listAccountIds(cfg: AssistMeConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: AssistMeConfig): string {
