...
export function listChannelMessageActions(cfg: AssistMeConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: AssistMeConfig): boolean {
...
export function supportsChannelMessageCards(cfg: AssistMeConfig): boolean {
