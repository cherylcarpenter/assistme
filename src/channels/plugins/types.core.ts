...
export type ChannelAgentToolFactory = (params: { cfg?: AssistMeConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AssistMeConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: AssistMeConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: AssistMeConfig }) => boolean;
  supportsCards?: (params: { cfg: AssistMeConfig }) => boolean;
