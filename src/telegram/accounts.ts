...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.ASSISTME_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: AssistMeConfig): string[] {
...
export function listTelegramAccountIds(cfg: AssistMeConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: AssistMeConfig): string {
...
function mergeTelegramAccountConfig(cfg: AssistMeConfig, accountId: string): TelegramAccountConfig {
  const {
    accounts: _ignored,
  ...
  // See: https://github.com/assistme/assistme/issues/30673
...
export function listEnabledTelegramAccounts(cfg: AssistMeConfig): ResolvedTelegramAccount[] {
