...
import type { AssistMeConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: AssistMeConfig, agentId: string) {
  try {
