...
const CLEANUP_STATE_KEY = Symbol.for("assistme.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("assistme.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("assistme.sessionWriteLockWatchdogState");
