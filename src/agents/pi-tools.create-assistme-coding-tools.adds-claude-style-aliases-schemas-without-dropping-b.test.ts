...
const defaultTools = createAssistMeCodingTools({ senderIsOwner: true });
...
describe("createAssistMeCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: AssistMeConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createAssistMeCodingTools({
    ...
    const anthropicTools = createAssistMeCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: AssistMeConfig = {
      tools: {
        exec: {
    ...
    const allowed = createAssistMeCodingTools({
    ...
    const denied = createAssistMeCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createAssistMeCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
