...
export function resolveSessionToolsVisibility(cfg: AssistMeConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: AssistMeConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: AssistMeConfig): AgentToAgentPolicy {
