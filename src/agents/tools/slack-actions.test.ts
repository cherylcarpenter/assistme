...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): AssistMeConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: AssistMeConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: AssistMeConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
