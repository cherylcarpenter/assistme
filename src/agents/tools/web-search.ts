...
type WebSearchConfig = NonNullable<AssistMeConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: AssistMeConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("assistme configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.assistme.ai/tools/web",
  };
}
  ...
  return withTrustedWebSearchEndpoint(
    {
      ...
      init: {
        ...
        headers: {
          ...
          "HTTP-Referer": "https://assistme.ai",
          "X-Title": "AssistMe Web Search",
        },
