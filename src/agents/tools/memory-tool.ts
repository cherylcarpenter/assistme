...
function resolveMemoryToolContext(options: { config?: AssistMeConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: AssistMeConfig): MemoryCitationsMode {
