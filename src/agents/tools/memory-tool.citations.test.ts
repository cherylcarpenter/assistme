...
function asAssistMeConfig(config: Partial<AssistMeConfig>): AssistMeConfig {
  return config as AssistMeConfig;
}

function createToolConfig() {
  return asAssistMeConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: AssistMeConfig = createToolConfig()) {
