...
function resolveAvatarSource(cfg: AssistMeConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AssistMeConfig, agentId: string): AgentAvatarResolution {
