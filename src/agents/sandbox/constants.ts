...
export const DEFAULT_SANDBOX_IMAGE = "assistme-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "assistme-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "assistme-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "assistme-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "assistme-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "assistme-sandbox-browser";
