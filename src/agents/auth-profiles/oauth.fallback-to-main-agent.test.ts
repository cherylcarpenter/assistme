...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveAssistMeAgentDir() returns mainAgentDir
    process.env.ASSISTME_STATE_DIR = tmpDir;
    process.env.ASSISTME_AGENT_DIR = mainAgentDir;
