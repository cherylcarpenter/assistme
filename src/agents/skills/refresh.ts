...
function resolveWatchPaths(workspaceDir: string, config?: AssistMeConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: AssistMeConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AssistMeConfig }) {
