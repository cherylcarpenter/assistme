...
type AgentEntry = NonNullable<NonNullable<AssistMeConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: AssistMeConfig): AgentEntry[] {
...
export function listAgentIds(cfg: AssistMeConfig): string[] {
...
export function resolveDefaultAgentId(cfg: AssistMeConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: AssistMeConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: AssistMeConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: AssistMeConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: AssistMeConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
