...
function resolveAdaptiveReadMaxBytes(options?: AssistMeReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createAssistMeReadTool(base, {
...
export function createAssistMeReadTool(
  base: AnyAgentTool,
  options?: AssistMeReadToolOptions,
): AnyAgentTool {
