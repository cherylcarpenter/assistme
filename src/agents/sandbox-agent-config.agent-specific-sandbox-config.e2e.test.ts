...
async function resolveContext(config: AssistMeConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): AssistMeConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
