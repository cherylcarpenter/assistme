...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.ASSISTME_TTS_PREFS;
      process.env.ASSISTME_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.ASSISTME_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: AssistMeConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
