...
function mergeSignalAccountConfig(cfg: AssistMeConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: AssistMeConfig): ResolvedSignalAccount[] {
