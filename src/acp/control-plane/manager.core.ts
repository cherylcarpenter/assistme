...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: AssistMeConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: AssistMeConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: AssistMeConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: AssistMeConfig }): Promise<void> {
