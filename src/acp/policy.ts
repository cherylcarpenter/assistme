...
export function isAcpEnabledByPolicy(cfg: AssistMeConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: AssistMeConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: AssistMeConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: AssistMeConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: AssistMeConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: AssistMeConfig, agentId: string): boolean {
