...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.assistme.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", ASSISTME_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.assistme.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.assistme.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when ASSISTME_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/com.assistme.gateway.plist",
    },
    {
      name: "uses profile-specific label when ASSISTME_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", ASSISTME_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.assistme.jbphoenix.plist",
    },
    {
      name: "prefers ASSISTME_LAUNCHD_LABEL over ASSISTME_PROFILE",
      env: {
        HOME: "/Users/test",
        ASSISTME_PROFILE: "jbphoenix",
        ASSISTME_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from ASSISTME_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        ASSISTME_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty ASSISTME_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        ASSISTME_PROFILE: "myprofile",
        ASSISTME_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.assistme.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
