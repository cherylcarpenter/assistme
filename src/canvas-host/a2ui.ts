...
export const A2UI_PATH = "/__assistme__/a2ui";

export const CANVAS_HOST_PATH = "/__assistme__/canvas";

export const CANVAS_WS_PATH = "/__assistme__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.assistmeCanvasA2UIAction.postMessage(...)
  // - Android: window.assistmeCanvasA2UIAction.postMessage(...)
  const handlerNames = ["assistmeCanvasA2UIAction"];
  ...
  globalThis.AssistMe = globalThis.AssistMe ?? {};
  globalThis.AssistMe.postMessage = postToNode;
  globalThis.AssistMe.sendUserAction = sendUserAction;
  globalThis.assistmePostMessage = postToNode;
  globalThis.assistmeSendUserAction = sendUserAction;
