    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["assistme directory self --channel slack", "Show the connected account identity."],
          [
            'assistme directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["assistme directory groups list --channel discord", "List available groups/channels."],
          [
            "assistme directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.assistme.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
