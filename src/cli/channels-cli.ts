    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["assistme channels list", "List configured channels and auth profiles."],
          ["assistme channels status --probe", "Run channel status checks and probes."],
          [
            "assistme channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["assistme channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.assistme.ai/cli/channels",
        )}\n`,
    );
