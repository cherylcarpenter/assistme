...
${formatHelpExamples([
  ['assistme agent --to +15555550123 --message "status update"', "Start a new session."],
  ['assistme agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'assistme agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'assistme agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['assistme agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.assistme.ai/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.assistme.ai/cli/agents")}\n`,
    );
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['assistme agents set-identity --agent main --name "AssistMe" --emoji "🦞"', "Set name + emoji."],
  ["assistme agents set-identity --agent main --avatar avatars/assistme.png", "Set avatar path."],
  [
    "assistme agents set-identity --workspace ~/.assistme/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "assistme agents set-identity --identity-file ~/.assistme/workspace/IDENTITY.md --agent main",
