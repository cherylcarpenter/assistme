      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["assistme gateway run", "Run the gateway in the foreground."],
            ["assistme gateway status", "Show service status and probe reachability."],
            ["assistme gateway discover", "Find local and wide-area gateway beacons."],
            ["assistme gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.assistme.ai/cli/gateway")}\n`,
      ),
  );
