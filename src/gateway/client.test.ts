...
function expectSecurityConnectError(
  ...
  expect(error.message).toContain("assistme doctor --fix");
...
describe("GatewayClient security checks", () => {
  const envSnapshot = captureEnv(["ASSISTME_ALLOW_INSECURE_PRIVATE_WS"]);
  ...
  it("allows ws:// to private addresses only with ASSISTME_ALLOW_INSECURE_PRIVATE_WS=1", () => {
