...
import { type AssistMeConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: AssistMeConfig): string[] {
...
export function listAgentsForGateway(cfg: AssistMeConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AssistMeConfig): string {
...
function resolveSessionStoreAgentId(cfg: AssistMeConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: AssistMeConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: AssistMeConfig): GatewaySessionsDefaults {
