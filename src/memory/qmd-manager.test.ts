...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: AssistMeConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: AssistMeConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__assistmeMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__assistmeMcporterColdStartWarned;
  });
