...
// Prefix for AssistMe-generated action IDs to scope our handler
const ASSISTME_ACTION_PREFIX = "assistme:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${ASSISTME_ACTION_PREFIX}`);

  // Handle AssistMe modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
