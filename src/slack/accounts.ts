...
function mergeSlackAccountConfig(cfg: AssistMeConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: AssistMeConfig): ResolvedSlackAccount[] {
