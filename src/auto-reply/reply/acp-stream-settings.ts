...
function resolveAcpStreamCoalesceIdleMs(cfg: AssistMeConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: AssistMeConfig): number {
...
export function resolveAcpProjectionSettings(cfg: AssistMeConfig): AcpProjectionSettings {
