...
function resolveMentionPatterns(cfg: AssistMeConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AssistMeConfig | undefined, agentId?: string): RegExp[] {
