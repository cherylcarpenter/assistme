...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@assistme", { botUsername: "assistme" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@assistme args", {
        botUsername: "assistme",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@assistme: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "assistme" })).toBe(
      "/help@otherbot",
    );
  });
