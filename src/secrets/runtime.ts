...
type SecretDefaults = NonNullable<AssistMeConfig["secrets"]>["defaults"];
...
function collectCandidateAgentDirs(config: AssistMeConfig): string[] {
  const dirs = new Set<string>();
  dirs.add(resolveUserPath(resolveAssistMeAgentDir()));
