...
export function listBindings(cfg: AssistMeConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: AssistMeConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AssistMeConfig) {
