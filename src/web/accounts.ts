...
export function listWhatsAppAuthDirs(cfg: AssistMeConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AssistMeConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: AssistMeConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AssistMeConfig): ResolvedWhatsAppAccount[] {
