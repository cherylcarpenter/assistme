...
describe("preflightDiscordMessage", () => {
  ...
  it("bypasses mention gating in bound threads for allowed bot senders", async () => {
    ...
    const result = await preflightDiscordMessage({
      ...
      } as import("../../config/config.js").AssistMeConfig,
      discordConfig: {
        allowBots: true,
      } as NonNullable<import("../../config/config.js").AssistMeConfig["channels"]>["discord"],
      accountId: "default",
      token: "token",
      runtime: {} as import("../../runtime.js").RuntimeEnv,
      botUserId: "assistme-bot",
  ...
  it("uses attachment content_type for guild audio preflight mention detection", async () => {
    transcribeFirstAudioMock.mockResolvedValue("hey assistme");
    ...
    const result = await preflightDiscordMessage({
      cfg: {
        ...
        messages: {
          groupChat: {
            mentionPatterns: ["assistme"],
          },
        },
      } as import("../../config/config.js").AssistMeConfig,
      discordConfig: {} as NonNullable<
        import("../../config/config.js").AssistMeConfig["channels"]
      >["discord"],
      accountId: "default",
      token: "token",
      runtime: {} as import("../../runtime.js").RuntimeEnv,
