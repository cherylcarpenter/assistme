...
describe("agent components", () => {
  const createCfg = (): AssistMeConfig => ({}) as AssistMeConfig;
...
describe("discord component interactions", () => {
  const createCfg = (): AssistMeConfig =>
    ({
      channels: {
        discord: {
          replyToMode: "first",
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/assistme-sessions-test.json");
  });
