...
function mergeDiscordAccountConfig(cfg: AssistMeConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: AssistMeConfig): ResolvedDiscordAccount[] {
