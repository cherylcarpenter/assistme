...
function resolveAnthropicDefaultAuthMode(cfg: AssistMeConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AssistMeConfig): AssistMeConfig {
...
export function applyTalkApiKey(config: AssistMeConfig): AssistMeConfig {
...
export function applyTalkConfigNormalization(config: AssistMeConfig): AssistMeConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: AssistMeConfig): AssistMeConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AssistMeConfig): AssistMeConfig {
...
export function applyLoggingDefaults(cfg: AssistMeConfig): AssistMeConfig {
...
export function applyContextPruningDefaults(cfg: AssistMeConfig): AssistMeConfig {
...
export function applyCompactionDefaults(cfg: AssistMeConfig): AssistMeConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
