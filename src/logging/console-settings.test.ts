...
let originalAssistMeTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalAssistMeTestConsole = process.env.ASSISTME_TEST_CONSOLE;
  process.env.ASSISTME_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalAssistMeTestConsole === undefined) {
    delete process.env.ASSISTME_TEST_CONSOLE;
  } else {
    process.env.ASSISTME_TEST_CONSOLE = originalAssistMeTestConsole;
  }
