...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "assistme-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    envSnapshot = captureEnv(["ASSISTME_BUNDLED_HOOKS_DIR"]);
    process.env.ASSISTME_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  describe("loadInternalHooks", () => {
    ...
    const expectNoCommandHookRegistration = async (cfg: AssistMeConfig) => {
