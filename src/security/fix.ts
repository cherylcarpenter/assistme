...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AssistMeConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AssistMeConfig; env: NodeJS.ProcessEnv }): {
  cfg: AssistMeConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
