...
function resolveDefaultAccountId(cfg: AssistMeConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AssistMeConfig): boolean {
...
export function summarizeBindings(cfg: AssistMeConfig, bindings: AgentBinding[]): string[] {
