...
export function applyOpenrouterProviderConfig(cfg: AssistMeConfig): AssistMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: AssistMeConfig): AssistMeConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: AssistMeConfig): AssistMeConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: AssistMeConfig): AssistMeConfig {
...
export function applyMoonshotConfig(cfg: AssistMeConfig): AssistMeConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: AssistMeConfig): AssistMeConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: AssistMeConfig): AssistMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: AssistMeConfig): AssistMeConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: AssistMeConfig): AssistMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: AssistMeConfig): AssistMeConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: AssistMeConfig): AssistMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: AssistMeConfig): AssistMeConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: AssistMeConfig): AssistMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: AssistMeConfig): AssistMeConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: AssistMeConfig): AssistMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: AssistMeConfig): AssistMeConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: AssistMeConfig): AssistMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: AssistMeConfig): AssistMeConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: AssistMeConfig): AssistMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: AssistMeConfig): AssistMeConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: AssistMeConfig): AssistMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: AssistMeConfig): AssistMeConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: AssistMeConfig): AssistMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: AssistMeConfig): AssistMeConfig {
...
export function applyQianfanProviderConfig(cfg: AssistMeConfig): AssistMeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: AssistMeConfig): AssistMeConfig {
