...
export function applyVercelAiGatewayProviderConfig(cfg: AssistMeConfig): AssistMeConfig {
...
export function applyVercelAiGatewayConfig(cfg: AssistMeConfig): AssistMeConfig {
