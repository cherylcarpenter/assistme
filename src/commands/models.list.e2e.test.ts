...
const ensureAssistMeModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveAssistMeAgentDir = vi.fn().mockReturnValue("/tmp/assistme-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/assistme-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureAssistMeModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveAssistMeAgentDir,
}));
