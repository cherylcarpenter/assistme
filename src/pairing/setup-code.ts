...
function resolveGatewayPort(cfg: AssistMeConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: AssistMeConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.ASSISTME_GATEWAY_PASSWORD?.trim() ||
