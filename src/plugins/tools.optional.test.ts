...
const loadAssistMePluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadAssistMePlugins: (params: unknown) => loadAssistMePluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadAssistMePluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadAssistMePluginsMock.mockClear();
  });
