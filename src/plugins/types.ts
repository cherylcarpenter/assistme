...
export type AssistMePluginConfigSchema = {
...
export type AssistMePluginToolContext = {
...
export type AssistMePluginToolFactory = (
  ctx: AssistMePluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type AssistMePluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type AssistMePluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<AssistMeConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type AssistMePluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current AssistMe configuration */
  config: AssistMeConfig;
 ...
 */
export type AssistMePluginCommandDefinition = {
...
export type AssistMePluginHttpRouteAuth = "gateway" | "plugin";
export type AssistMePluginHttpRouteMatch = "exact" | "prefix";

export type AssistMePluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type AssistMePluginHttpRouteParams = {
  path: string;
  handler: AssistMePluginHttpRouteHandler;
  auth: AssistMePluginHttpRouteAuth;
  match?: AssistMePluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type AssistMePluginCliContext = {
  program: Command;
  config: AssistMeConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type AssistMePluginCliRegistrar = (ctx: AssistMePluginCliContext) => void | Promise<void>;

export type AssistMePluginServiceContext = {
  config: AssistMeConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type AssistMePluginService = {
  id: string;
  start: (ctx: AssistMePluginServiceContext) => void | Promise<void>;
  stop?: (ctx: AssistMePluginServiceContext) => void | Promise<void>;
};

export type AssistMePluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type AssistMePluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: AssistMePluginConfigSchema;
  register?: (api: AssistMePluginApi) => void | Promise<void>;
  activate?: (api: AssistMePluginApi) => void | Promise<void>;
};

export type AssistMePluginModule =
  | AssistMePluginDefinition
  | ((api: AssistMePluginApi) => void | Promise<void>);

export type AssistMePluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | AssistMePluginToolFactory,
    opts?: AssistMePluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: AssistMePluginHookOptions,
  ) => void;
  registerHttpRoute: (params: AssistMePluginHttpRouteParams) => void;
  registerChannel: (registration: AssistMePluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: AssistMePluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: AssistMePluginService) => void;
