...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/assistme/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/assistme/extensions",
        global: "/Users/x/.assistme/extensions",
        workspace: "/Users/x/ws/.assistme/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.assistme/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/assistme/extensions",
        global: "/Users/x/.assistme/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.assistme/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/assistme/extensions",
        global: "/Users/x/.assistme/extensions",
