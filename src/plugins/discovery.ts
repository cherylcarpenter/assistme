...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @assistme/voice-call -> voice-call).
...
export function discoverAssistMePlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".assistme", "extensions")];
