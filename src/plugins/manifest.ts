...
export const PLUGIN_MANIFEST_FILENAME = "assistme.plugin.json";
...
// package.json "assistme" metadata (used for onboarding/catalog)
...
export type AssistMePackageManifest = {
  extensions?: string[];
...
): AssistMePackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
