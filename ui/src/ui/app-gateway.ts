...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "assistme-control-ui",
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as AssistMeApp);
      void loadAgents(host as unknown as AssistMeApp);
      void loadToolsCatalog(host as unknown as AssistMeApp);
      void loadNodes(host as unknown as AssistMeApp, { quiet: true });
      void loadDevices(host as unknown as AssistMeApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (state === "final") {
    void loadSessions(host as unknown as AssistMeApp, {
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as AssistMeApp, payload);
  handleTerminalChatEvent(host, payload, state);
  if (state === "final" && shouldReloadHistoryForFinalEvent(payload)) {
    void loadChatHistory(host as unknown as AssistMeApp);
  }
}
