...
import type { ReplyPayload, AssistMeConfig } from "assistme/plugin-sdk";
import { createReplyPrefixOptions } from "assistme/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as AssistMeConfig;
