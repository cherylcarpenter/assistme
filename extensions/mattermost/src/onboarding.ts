import type { ChannelOnboardingAdapter, AssistMeConfig, WizardPrompter } from "assistme/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "assistme/plugin-sdk/account-id";
import {
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.assistme.ai/channels/mattermost",
    ].join("\n"),
