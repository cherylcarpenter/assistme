import type { AssistMeConfig, PluginRuntime, ResolvedLineAccount } from "assistme/plugin-sdk";
...
async function runLogoutScenario(params: { cfg: AssistMeConfig; accountId: string }): Promise<{
