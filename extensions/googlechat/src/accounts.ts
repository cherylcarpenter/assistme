...
export function listGoogleChatAccountIds(cfg: AssistMeConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: AssistMeConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: AssistMeConfig): ResolvedGoogleChatAccount[] {
