...
export function listZalouserAccountIds(cfg: AssistMeConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: AssistMeConfig): string {
...
function mergeZalouserAccountConfig(cfg: AssistMeConfig, accountId: string): ZalouserAccountConfig {
