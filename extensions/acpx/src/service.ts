...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "assistme/plugin-sdk";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: AssistMePluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: AssistMePluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
