...
import { fetchWithSsrFGuard, isWSL2Sync } from "assistme/plugin-sdk";

const CLIENT_ID_KEYS = ["ASSISTME_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to AssistMe.</p></body></html>",
        );
