...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "assistme/plugin-sdk";
...
import { resolvePreferredAssistMeTmpDir } from "../../../src/infra/tmp-assistme-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredAssistMeTmpDir(), "msteams-mention-"));
