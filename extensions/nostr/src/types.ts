...
function resolveConfiguredDefaultNostrAccountId(cfg: AssistMeConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: AssistMeConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: AssistMeConfig): string {
