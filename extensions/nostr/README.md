...
Nostr DM channel plugin for AssistMe using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to AssistMe. It enables your bot to:
...
# Configure assistme to use local relay
