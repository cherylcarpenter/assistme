...
export function listBlueBubblesAccountIds(cfg: AssistMeConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: AssistMeConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: AssistMeConfig): ResolvedBlueBubblesAccount[] {
