...
import { resolveChannelMediaMaxBytes, type AssistMeConfig } from "assistme/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: AssistMeConfig; accountId?: string }): string[] {
