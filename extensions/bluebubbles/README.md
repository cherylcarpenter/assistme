...
This directory contains the **BlueBubbles external channel plugin** for AssistMe.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `assistme/plugin-sdk` helpers.
