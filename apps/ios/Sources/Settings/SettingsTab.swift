...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = AssistMeLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = AssistMeLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.assistme.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected AssistMe agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while AssistMe is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for AssistMe. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(AssistMeLocationMode.off.rawValue)
                            Text("While Using").tag(AssistMeLocationMode.whileUsing.rawValue)
                            Text("Always").tag(AssistMeLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while AssistMe is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("AssistMe", value: DeviceInfoHelper.assistMeVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = AssistMeLocationMode(rawValue: newValue) else { return }
                Task {
