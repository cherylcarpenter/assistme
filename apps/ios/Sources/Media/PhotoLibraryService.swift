...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: AssistMePhotosLatestParams) async throws -> AssistMePhotosLatestPayload {
        ...
        var results: [AssistMePhotoPayload] = []
        ...
        return AssistMePhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> AssistMePhotoPayload
    {
