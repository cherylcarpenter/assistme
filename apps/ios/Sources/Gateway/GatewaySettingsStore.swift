...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.assistme.gateway"
    private static let nodeService = "ai.assistme.node"
    private static let talkService = "ai.assistme.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.assistme.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.assistme.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("assistme-gateway.log")
    }
