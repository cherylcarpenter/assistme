...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .assistmeSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AssistMePaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AssistMePaths.stateDirURL.path
...
extension Notification.Name {
    static let assistmeSelectSettingsTab = Notification.Name("assistmeSelectSettingsTab")
}
