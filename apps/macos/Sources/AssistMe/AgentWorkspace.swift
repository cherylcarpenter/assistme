...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.assistme", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return AssistMeConfigFile.defaultWorkspaceURL() }
