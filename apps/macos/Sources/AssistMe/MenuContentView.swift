...
/// Menu contents for the AssistMe menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About AssistMe") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "AssistMe Not Configured"
        case .remote:
            "Remote AssistMe Active"
        case .local:
            "AssistMe Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .assistmeSelectSettingsTab, object: tab)
        }
    }
