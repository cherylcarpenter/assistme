...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = AssistMeConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = AssistMeConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = AssistMeConfigFile.loadDict()
            ...
            AssistMeConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/assistme"
        state.remoteCliPath = ""
        return state
    }
}
