...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.assistme", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".assistme/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.assistmeCommand(
            subcommand: "gateway",
