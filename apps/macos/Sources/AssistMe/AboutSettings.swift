...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/assistme/assistme") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/assistme/assistme")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://assistme.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "AssistMeBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AssistMeBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "AssistMeGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AssistMeGitCommit") as? String) ??
            "unknown"
    }
