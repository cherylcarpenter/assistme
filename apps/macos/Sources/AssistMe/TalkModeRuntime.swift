...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.assistme", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.assistme", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [AssistMeChatMessage] = messages.compactMap { item in
