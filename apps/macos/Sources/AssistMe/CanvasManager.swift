...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.assistme", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("AssistMe/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__assistme__/a2ui/").absoluteString + "?platform=macos"
    }
