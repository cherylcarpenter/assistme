...
enum AssistMeConfigFile {
    private static let logger = Logger(subsystem: "ai.assistme", category: "config")
    ...
    static func stateDirURL() -> URL {
        AssistMePaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        AssistMePaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-assistme-config-file",
            "event": "config.write",
