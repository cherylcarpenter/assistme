...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.assistme", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other AssistMe windows, but below the system’s pop-up menus.
