...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.assistme", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        AssistMePaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        AssistMePaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
