...
enum UIStrings {
    static let welcomeTitle = "Welcome to AssistMe"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "assistme.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: AssistMeChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g assistme@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: AssistMeChatViewModel(
