...
import ai.assistme.android.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("AssistMe is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
