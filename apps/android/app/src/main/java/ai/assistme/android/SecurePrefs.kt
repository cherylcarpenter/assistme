...
class SecurePrefs(context: Context) {
  companion object {
    val defaultWakeWords: List<String> = listOf("assistme", "claude")
    private const val displayNameKey = "node.displayName"
    private const val voiceWakeModeKey = "voiceWake.mode"
    private const val plainPrefsName = "assistme.node"
    private const val securePrefsName = "assistme.node.secure"
  }
