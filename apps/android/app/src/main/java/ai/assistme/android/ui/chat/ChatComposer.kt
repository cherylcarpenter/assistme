...
import ai.assistme.android.ui.mobileSurface
import ai.assistme.android.ui.mobileText
import ai.assistme.android.ui.mobileTextSecondary
import ai.assistme.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.assistme.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.assistme.android.ui.mobileFontFamily,
