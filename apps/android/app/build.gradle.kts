...
android {
    namespace = "ai.assistme.android"
    compileSdk = 36

    sourceSets {
        getByName("main") {
            assets.directories.add("../../shared/AssistMeKit/Sources/AssistMeKit/Resources")
        }
    }

    defaultConfig {
        applicationId = "ai.assistme.android"
        minSdk = 31
        targetSdk = 36
    ...
    onVariants { variant ->
        variant.outputs
            ...
            .forEach { output ->
                ...
                val outputFileName = "assistme-$versionName-$buildType.apk"
