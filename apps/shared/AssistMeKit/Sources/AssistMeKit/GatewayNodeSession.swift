...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.assistme", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.assistme", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: AssistMeProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
