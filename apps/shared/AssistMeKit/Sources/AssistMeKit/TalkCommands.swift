...
public enum AssistMeTalkCommand: String, Codable, Sendable {
...
public struct AssistMeTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct AssistMeTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
