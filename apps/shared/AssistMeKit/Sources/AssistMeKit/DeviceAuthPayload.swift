...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: AssistMeProtocol.AnyCodable]?
    {
        ...
        return [
            "id": AssistMeProtocol.AnyCodable(identity.deviceId),
            "publicKey": AssistMeProtocol.AnyCodable(publicKey),
            "signature": AssistMeProtocol.AnyCodable(signature),
            "signedAt": AssistMeProtocol.AnyCodable(signedAtMs),
            "nonce": AssistMeProtocol.AnyCodable(nonce),
        ]
    }
}
