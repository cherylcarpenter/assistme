...
public enum AssistMeCanvasA2UICommand: String, Codable, Sendable {
...
public struct AssistMeCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AssistMeCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
