...
@MainActor
public struct AssistMeChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: AssistMeChatViewModel
    ...
    public init(
        viewModel: AssistMeChatViewModel,
    ...
    private var visibleMessages: [AssistMeChatMessage] {
        let base: [AssistMeChatMessage]
    ...
    private func mergeToolResults(in messages: [AssistMeChatMessage]) -> [AssistMeChatMessage] {
        ...
        for message in messages {
            ...
            let merged = AssistMeChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: AssistMeChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: AssistMeChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: AssistMeChatMessage) -> String {
