...
public typealias AssistMePlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AssistMePlatformImage = UIImage
#endif

public struct AssistMeChatUsageCost: Codable, Hashable, Sendable {
...
public struct AssistMeChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AssistMeChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AssistMeChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct AssistMeChatMessageContent: Codable, Hashable, Sendable {
...
public struct AssistMeChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [AssistMeChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AssistMeChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AssistMeChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: AssistMeChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(AssistMeChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([AssistMeChatMessageContent].self, forKey: .content) {
...
public struct AssistMeChatHistoryPayload: Codable, Sendable {
...
public struct AssistMeSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AssistMeSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AssistMeSessionPreviewItem]
}

public struct AssistMeSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AssistMeSessionPreviewEntry]

    public init(ts: Int, previews: [AssistMeSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AssistMeChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AssistMeChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AssistMeAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct AssistMeChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct AssistMeGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AssistMePendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AssistMePlatformImage?
...
public struct AssistMeChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
